...
plt.plot(z[0].detach().cpu()[:, 0], z[0].detach().cpu()[:, 1], ".-", label="A")
# print(z[1])
plt.plot(z[1].detach().cpu()[:, 0], z[1].detach().cpu()[:, 1], ".-", label="B")
plt.legend()
# theme.apply_transforms()
# plt.tight_layout()
# plt.show()
plt.savefig("Gaqtest4-10")
plt.clf()
# losss = torch.load("Los4-10")
# Los = []
# for it in losss:
#     Los.append(it.item())
